...
function preload()
{
  ...
  imgturban = loadImage("https://i.ibb.co/bHZYw8G/BIHAR-1.png");
}
...
function drawturban()
{
  ...
  if (positions !== false)
  {
    ...
    const wy = Math.abs(positions[7][1] - Math.min(positions[16][1], positions[20][1])) * 1.4; // The height is given by the distance from nose to chin, times 2
