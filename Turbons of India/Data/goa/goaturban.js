...
function preload()
{
  ...
  imgturban = loadImage("https://i.ibb.co/hYQ6F1h/GOA-1.png")
}
...
function drawturban()
{
  ...
  {
    push();
    const wx = Math.abs(positions[13][0] - positions[1][0]) * 2.6; // The width is given by the face width, based on the geometry
