...
function preload()
{
  ...
  imgturban = loadImage("https://i.ibb.co/nLz9LyB/MP-1.png");
}
...
function drawturban()
{
  ...
  if (positions !== false)
  {
    ...
    const wy = Math.abs(positions[7][1] - Math.min(positions[16][1], positions[20][1])) * 2.3; // The height is given by the distance from nose to chin, times 2
    translate(-wx/2,-wy/1.1);
