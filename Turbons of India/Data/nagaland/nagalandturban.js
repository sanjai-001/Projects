...
function preload()
{
  ...
  imgturban = loadImage("https://i.ibb.co/5r09j2z/NAGALAND-1.png");
}
...
function drawturban()
{
  ...
  {
    push();
    const wx = Math.abs(positions[13][0] - positions[1][0]) * 2.0; // The width is given by the face width, based on the geometry
